...
<div class="table-responsive">
    ...
    <tr>
        ...
        @if($nestbookings->VCApproval == 0)
        <td>
        <a href = 'shownestvc/{{ $nestbookings->BookingId }}'>View</a></br>
       
        </td>
        @else
        <td>
        <a href = 'shownestvc/{{ $nestbookings->BookingId }}'>View</a></br>
        <a href = 'nestapprove/{{ $nestbookings->BookingId }}'>Approve</a></br>
        <a href = 'nestnotapprove/{{ $nestbookings->BookingId }}'>Not Approve</a>
