...
<div class="table-responsive">
    ...
    <tr>
        ...
        <td>@if($hrbooking->Status=='Payment Requested')<a class="btn btn-primary" href="https://www.sab.ac.lk/payment-test/?event=reservation&paycategory=Holiday Resort&payname={{$hrbooking->GuestName}}&payid={{$hrbooking->BookingId}}&paramount={{$hrbooking->payment_total}}&payother={{$hrbooking->BookingId}}&payemail={{auth()->user()->email}}">Pay Now</a>@endif</td>
